...
if (!isset($_POST['commentId']) || !isset($_POST['newContent'])) {
...
try {
    ...
    $query = "UPDATE posts_comments SET content = ? WHERE id = ? AND comment_author_id = ?";
    ...
    if ($stmt->affected_rows > 0) {
        ...
        echo json_encode(['status' => 'error', 'message' => 'Nie można zaktualizować komentarza']);
    }
